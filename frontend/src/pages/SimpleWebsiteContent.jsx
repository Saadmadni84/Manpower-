      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <ul style={{ 
            ...
            <li>This is a simplified version of the CMS</li>
            <li>The full version includes rich text editor, media upload, and preview</li>
            <li>Backend API integration will be added once this UI is confirmed working</li>
            <li>All 5 pages (Home, About, Contact, Career, Clients) are accessible via tabs</li>
          </ul>
        </div>
      </div>
    </div>
...
export default SimpleWebsiteContent;
